...
- The `Demo evidence` panel renders a safe Markdown evidence preview with job status, timeline stages, usage, cache counts, artifact hashes, result bundle URL, diagnostics URL, and backend evidence URL.
