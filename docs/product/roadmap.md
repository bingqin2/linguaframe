...
- Lip sync.
- Full nonlinear video editing, persistent waveform artifacts, multitrack automation curves, voice cloning, uploaded reference audio, or replacing existing subtitle review artifacts.
