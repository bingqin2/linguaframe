...
- Lip sync.
- Full nonlinear video editing, decoded-audio waveform rendering, multitrack automation curves, voice cloning, uploaded reference audio, or replacing existing subtitle review artifacts.
