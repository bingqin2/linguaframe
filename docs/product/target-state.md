...
- TTS dubbing audio.
- Time-coded custom narration segments with provider voice presets, quick script paste import, editable timeline bars, local row editing commands, local draft history, and metadata-derived waveform overview for adding explanatory voiceover on top of localization output.
