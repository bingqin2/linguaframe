...
- Validate demo narration setup through the browser `Narration draft history`, `Demo narration preset`, `Render narration demo`, and `Render review` panels, backend preset apply/preflight/render and render-review responses, terminal `scripts/demo/narration-demo-preset.sh`, `scripts/demo/narration-demo-render-preflight.sh`, `scripts/demo/narration-demo-render.sh`, and `scripts/demo/narration-render-review.sh`, and optional full Tears narration render before narration evidence/review export.
