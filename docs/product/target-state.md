...
- Validate offline reviewer handoff through the browser `Demo reviewer workspace`, browser `Demo handoff portal`, backend reviewer/portal JSON/Markdown/ZIP, recovery handoff ZIP, narration delivery JSON/Markdown summaries inside final handoff packages, and terminal full-video `demo-reviewer-workspace.zip` plus `demo-handoff-portal.zip` output.
- Keep secrets local.
