...
- TTS dubbing audio.
- Time-coded custom narration segments with provider voice presets, editable timeline bars, and metadata-derived waveform overview for adding explanatory voiceover on top of localization output.
