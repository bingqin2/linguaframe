...
The selected job view also includes a `Subtitle draft editor` panel. Use it to correct generated target subtitles by segment, save a draft overlay, reset unsaved edits, clear saved edits, and export corrected JSON, SRT, or VTT. Draft exports are separate from generated subtitle artifacts; saving a draft does not regenerate TTS audio or the subtitle-burned video.
