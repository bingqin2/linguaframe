...
export async function getSessionNarrationProductionBoard(limit?: number): Promise<SessionNarrationProductionBoard> {
  const query = new URLSearchParams();
  if (limit !== undefined) {
    query.set('limit', String(limit));
  }
  const suffix = query.toString() ? `?${query.toString()}` : '';
  return requestJson<SessionNarrationProductionBoard>(`/api/operator/session-narration-production-board${suffix}`, {
    method: 'GET'
  });
}

export async function downloadSessionNarrationProductionBoardMarkdown(limit?: number): Promise<Blob> {
  const query = new URLSearchParams();
  if (limit !== undefined) {
    query.set('limit', String(limit));
  }
  const suffix = query.toString() ? `?${query.toString()}` : '';
  return requestBlob(`/api/operator/session-narration-production-board/markdown/download${suffix}`, {
    method: 'GET'
  });
}
...
export async function downloadNarrationSceneBoardMarkdown(jobId: string): Promise<Blob> {
  return requestBlob(
    `/api/jobs/${encodeURIComponent(jobId)}/narration-scene-board/markdown/download`,
    {
      method: 'GET'
    }
  );
...
export async function getNarrationRenderReview(jobId: string): Promise<NarrationRenderReview> {
  return requestJson<NarrationRenderReview>(
    `/api/jobs/${encodeURIComponent(jobId)}/narration-render-review`,
    {
      method: 'GET'
    }
  );
...
export async function downloadNarrationRenderReviewMarkdown(jobId: string): Promise<Blob> {
  return requestBlob(
    `/api/jobs/${encodeURIComponent(jobId)}/narration-render-review/markdown/download`,
    {
      method: 'GET'
    }
  );
...
export async function getNarrationDeliveryPackage(jobId: string): Promise<NarrationDeliveryPackage> {
  return requestJson<NarrationDeliveryPackage>(
    `/api/jobs/${encodeURIComponent(jobId)}/narration-delivery-package`,
    {
      method: 'GET'
    }
  );
...
export async function downloadNarrationDeliveryPackageMarkdown(jobId: string): Promise<Blob> {
  return requestBlob(
    `/api/jobs/${encodeURIComponent(jobId)}/narration-delivery-package/markdown/download`,
    {
      method: 'GET'
    }
  );
...
export async function downloadNarrationDeliveryPackageZip(jobId: string): Promise<Blob> {
  return requestBlob(
    `/api/jobs/${encodeURIComponent(jobId)}/narration-delivery-package/download`,
    {
      method: 'GET'
    }
  );
